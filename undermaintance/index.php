					...
					<div class="bg-dark text-white">
						...
						<div class="card-img-overlay justify-content-center">
							<div class="pembungkus">
								...
								<h1 class="card-title display-4" style="color: #e5c511">
									COMING SOON
								</h1>
								<p class="fw-light">
									-Providing the best quality sofas and springbeds-
								</p>
								<!-- countdown -->
								<div class="row">
									<div class="col display-2 px-5" id="hari"></div>
									<div class="col display-2 px-5" id="jam"></div>
									<div class="col display-2 px-5" id="menit"></div>
									<div class="col display-2 px-5" id="detik"></div>
								</div>
								<div class="row">
									<div class="col h6">Days</div>
									<div class="col h6">Hours</div>
									<div class="col h6">Minutes</div>
									<div class="col h6">Seconds</div>
								</div>
								<!-- countdown -->
