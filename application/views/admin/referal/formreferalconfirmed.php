                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header">
                            <h4>Form Belum Terkonfirmasi</h4>
                        </div>
                        <div class="col">
                                    ...
                                    <tbody id="showdata">
                                        ...
                                        foreach ($formreferal as $formreferal) { ?>
                                            <tr>
                                                ...
                                                <td><?= $formreferal['address'] ?></td>
                                                <td><?= $formreferal['number'] ?></td>
                                                <td><?= $formreferal['email'] ?></td>
                                                <td><a href="#" class="pop"><img width="200" height="90" src="<?= base_url('assets/user/img/be/' . $formreferal['photo']) ?>"></a></td>
                                                <td></td>
